...
import { FiHome, FiFileText, FiMessageSquare, FiUsers, FiSettings, FiLogOut, FiBarChart2, FiFolder, FiTag, FiGlobe, FiCalendar, FiMenu, FiX, FiCpu } from 'react-icons/fi'
...
const navItems = [
  ...
  { to: '/admin/models', label: '模型配置', icon: FiCpu },
